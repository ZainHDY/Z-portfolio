...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: 'aboutBio', title: 'About / Bio', type: 'object', fields: [{ name: 'en', title: 'English', type: 'array', of: [{ type: 'block' }] }, { name: 'ar', title: 'Arabic', type: 'array', of: [{ type: 'block' }] }] }),
    ...
    defineField({ name: 'brandMark', title: 'Brand Mark / Favicon (ZH)', type: 'image', options: { hotspot: true }, description: 'Upload your ZH star mark here. This can replace the favicon/brand mark later without changing code.' }),
